<div class="container">
    ...
    if ($DATA['project'] != null) {
        ...
        <a href="../list_sprints_of_project.php?project_id='. $id .'" class="btn btn-info">Sprints</a>
        <a href="../add_user_to_project.php?project_id='. $id .'" class="btn btn-info">Ajouter un membre</a>
